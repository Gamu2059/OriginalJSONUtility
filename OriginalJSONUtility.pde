public final class JsonArray extends JsonUtility {
  ...
  /**
   各パラメーターの追加
   */
  public void AddString(Object elem) {
    AddElement(stringToken+elem.toString()+stringToken);
  }

  public void AddInt(Object elem) {
    AddElement(elem);
  }

  public void AddFloat(Object elem) {
    AddElement(elem);
  }

  public void AddBoolean(Object elem) {
    AddElement(elem);
  }

  public void AddJsonObject(Object elem) {
    AddElement(elem);
  }

  public void AddJsonArray(Object elem) {
    AddElement(elem);
  }
  ...
  /**
   各パラメーターの設定
   */
  public void SetString(int index, Object elem) {
    SetElement(index, stringToken+elem.toString()+stringToken);
  }

  public void SetInt(int index, Object elem) {
    SetElement(index, elem);
  }

  public void SetFloat(int index, Object elem) {
    SetElement(index, elem);
  }

  public void SetBoolean(int index, Object elem) {
    SetElement(index, elem);
  }

  public void SetJsonObject(int index, Object elem) {
    SetElement(index, elem);
  }

  public void SetJsonArray(int index, Object elem) {
    SetElement(index, elem);
  }

  private void SetElement(int index, Object elem) {
    int elemSize=_elem.size();
    if (index<0) {
...
public final class JsonObject extends JsonUtility {
  ...
  /**
   各パラメーターの設定
   */
  public void SetString(String name, Object elem) {
    SetElement(name, stringToken+elem.toString()+stringToken);
  }

  public void SetInt(String name, Object elem) {
    SetElement(name, elem);
  }

  public void SetFloat(String name, Object elem) {
    SetElement(name, elem);
  }

  public void SetBoolean(String name, Object elem) {
    SetElement(name, elem);
  }

  public void SetJsonObject(String name, Object elem) {
    SetElement(name, elem);
  }

  public void SetJsonArray(String name, Object elem) {
    SetElement(name, elem);
  }
